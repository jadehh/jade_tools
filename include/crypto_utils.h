...
public:
    ...
    // 加密接口
    jade::JadeCryptoUtil::CryptoResult encryptDataToMemory(const std::vector<unsigned char>& inputData,
                                                           std::vector<unsigned char>& outputData) const;

    jade::JadeCryptoUtil::CryptoResult encryptFileToMemory(const std::string& inputFile,
                                                           std::vector<unsigned char>& outputData) const;

    [[nodiscard]] jade::JadeCryptoUtil::CryptoResult encryptFileToFile(const std::string& inputFile,
...
private:
    ...
    jade::JadeCryptoUtil::CryptoResult processData(const std::vector<unsigned char>& inputData,
                                                   std::vector<unsigned char>& outputData, bool encrypt) const;
    [[nodiscard]] jade::JadeCryptoUtil::CryptoResult processFile(const std::string& inputFile,
                                                                 const std::string& outputFile, bool encrypt) const;
